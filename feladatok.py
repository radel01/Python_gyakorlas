...
def masodik():
    ...
    while i < 11:
        ...
        if szam % 3 == 0:
            print("Ez a szám hárommal osztható: " + str(szam))
        else:
...
def negyedik():
    ...
    while not ((szam % 2 == 0) and (szam > 9) and (szam < 100)):
        szam = int(input("Kérem adjon meg egy számot!"))
    print("Ez a szám kétjegyű, és páros: " + str(szam))
...
def tizedik():
    print(
        "Kérem adja meg a számokat, amiknek az átlagát szeretné kiszámolni!\n0-val jelezheti, hogy a kívánt számokat "
        "megadta")
...
def tizenegyedik():
    print(
        ...
        "hogy a kívánt számokat megadta")
    szam = int(input("Adja meg a számot!"))
    eredmeny = 0
    sorszam = 0
    while not (szam == 0):
